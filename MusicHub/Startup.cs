        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services.AddDbContext<MusicHubDbContext>(options =>
                options.UseSqlServer(
                    ...
                    x => x.MigrationsAssembly("MusicHub.Core")));

            services.AddDefaultIdentity<IdentityUser>(options => options.SignIn.RequireConfirmedAccount = true)
                .AddEntityFrameworkStores<MusicHubDbContext>();

            services
                .AddScoped<IMusicHubRepository, MusicHubRepository>()
                .AddScoped<IWriterService, WriterService>()
                .AddScoped<IProducerService, ProducerService>()
                .AddScoped<IPerformerService, PerformerService>()
